<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a href="{{ route('customer.profile') }}"><i class="far fa-user"></i> My Profile</a></li>
      <li><a href="dsahboard_address.html"><i class="fal fa-gift-card"></i> Addresses</a></li>
      <li>
          <form method="POST" action="{{ route('logout-cus') }}">
            @csrf
            <a href="route('logout-cus')"
                    onclick="event.preventDefault();
                    this.closest('form').submit();"><i class="far fa-sign-out-alt"></i>Log out
            </a>
          </form>
